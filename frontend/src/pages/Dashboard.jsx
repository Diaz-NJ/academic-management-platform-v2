...
<nav className="bg-white/95 backdrop-blur-sm shadow-md border-b-2 border-gray-100">
  <div className="max-w-8xl mx-auto px-3 sm:px-8 lg:px-12">
    ...
    {mobileMenuOpen && (
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-10 py-3 md:py-6">
        {activeTab === 'dashboard' && (
          <>
            {/* Page Title - Mobile Optimized */}
<div className="mb-3 md:mb-6">
  <h1 className="text-2xl md:text-4xl font-bold mb-1 leading-tight">
...
<div className="grid grid-cols-2 lg:grid-cols-4 gap-2 md:gap-4 mb-3 md:mb-6">
              <div className="card-hover bg-gradient-to-br from-blue-500 to-blue-600 text-white p-3 md:p-5 rounded-lg shadow-lg cursor-pointer">
  <p className="text-[10px] md:text-xs font-medium opacity-90 uppercase tracking-wide mb-0.5 md:mb-1 leading-tight">
    Pending Tasks
  </p>
  <p className="text-2xl md:text-5xl font-bold tabular-nums mb-0.5 md:mb-1">
    {stats.pending}
  </p>
  <p className="text-[10px] md:text-xs opacity-75">Tasks waiting</p>
</div>

<div className="card-hover bg-gradient-to-br from-yellow-500 to-yellow-600 text-white p-3 md:p-5 rounded-lg shadow-lg cursor-pointer">
  <p className="text-[10px] md:text-xs font-medium opacity-90 uppercase tracking-wide mb-0.5 md:mb-1 leading-tight">
    In Progress
  </p>
  <p className="text-2xl md:text-5xl font-bold tabular-nums mb-0.5 md:mb-1">
  ...
  <p className="text-[10px] md:text-xs opacity-75">Working on</p>
</div>

<div className="card-hover bg-gradient-to-br from-green-500 to-green-600 text-white p-3 md:p-5 rounded-lg shadow-lg cursor-pointer">
  <p className="text-[10px] md:text-xs font-medium opacity-90 uppercase tracking-wide mb-0.5 md:mb-1 leading-tight">
    Completed
  </p>
  <p className="text-2xl md:text-5xl font-bold tabular-nums mb-0.5 md:mb-1">
  ...
  <p className="text-[10px] md:text-xs opacity-75">Finished</p>
</div>

<div className="card-hover bg-gradient-to-br from-purple-500 to-purple-600 text-white p-3 md:p-5 rounded-lg shadow-lg cursor-pointer">
  <p className="text-[10px] md:text-xs font-medium opacity-90 uppercase tracking-wide mb-0.5 md:mb-1 leading-tight">
    Completion
  </p>
  <p className="text-2xl md:text-5xl font-bold tabular-nums mb-0.5 md:mb-1">
  ...
  <p className="text-[10px] md:text-xs opacity-75">Progress</p>
</div>
            </div>
...
<div className="lg:col-span-2 bg-white rounded-lg shadow p-3 md:p-5">
  ...
  <p className="text-xs md:text-sm text-gray-600">
    Your upcoming schedule ({events.length} events)
                  ...
                  <button
  onClick={() => setActiveTab('calendar')}
  className="text-xs md:text-sm font-medium text-primary hover:text-blue-600 transition flex items-center space-x-1 px-2 md:px-3 py-1.5 md:py-2 hover:bg-blue-50 rounded-lg whitespace-nowrap"
>
...
<div className="space-y-2 md:space-y-4">
  <div className="card-hover bg-gradient-to-br from-indigo-500 to-indigo-600 text-white p-3 md:p-5 rounded-lg shadow-lg cursor-pointer">
    <div className="flex items-center justify-between mb-1 md:mb-2">
      <CalendarIcon className="w-6 h-6 md:w-10 md:h-10" />
    ...
    <p className="text-xs md:text-sm font-medium opacity-90">This Week</p>
    <p className="text-[10px] md:text-xs opacity-75 mt-0.5 md:mt-1">Scheduled events</p>
  </div>

  <div className="card-hover bg-gradient-to-br from-emerald-500 to-emerald-600 text-white p-3 md:p-5 rounded-lg shadow-lg cursor-pointer">
    <div className="flex items-center justify-between mb-1 md:mb-2">
    ...
    <p className="text-xs md:text-sm font-medium opacity-90">Total Tasks</p>
    <p className="text-[10px] md:text-xs opacity-75 mt-0.5 md:mt-1">All assignments</p>
  </div>

  <button
    onClick={() => setActiveTab('analytics')}
    className="w-full card-hover bg-white border-2 border-gray-200 p-3 md:p-5 rounded-lg text-left hover:border-primary transition"
  >
    <div className="flex items-center justify-between mb-1 md:mb-2">
      <BarChart3 className="w-6 h-6 md:w-8 md:h-8 text-primary" />
      <span className="text-xs md:text-sm font-medium text-primary">View →</span>
    </div>
    <p className="text-xs md:text-sm font-semibold text-gray-800">Analytics</p>
    <p className="text-[10px] md:text-xs text-gray-600 mt-0.5 md:mt-1">See detailed progress</p>
  </button>
</div>
            </div>
